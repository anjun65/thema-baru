...
$string['choosereadme'] = '<div class="clearfix"><div class="theme_screenshot"><img class=img-polaroid src="klass/images/logo.jpg" /><br/><p></p><h3>Theme Credits</h3><p><h3>Kalista theme</h3><p>This theme is based on the Boost Moodle theme.';

$string['configtitle'] = 'Kalista';
$string['connectus'] = 'Connect with us';
$string['contact'] = 'Contact';
$string['copyright_footer'] = 'Copyright';
$string['copyright_default'] = 'Copyright &copy; 2020 - Ardya';
$string['customcss'] = 'Custom CSS';
$string['customcssdesc'] = 'Whatever CSS rules you add to this textarea will be reflected in every page, making for easier customization of this theme.';
$string['defaultaddress'] = 'Jl. Orchard Boulevard, Belian, Kec. Batam Kota, Kota Batam, Kepulauan Riau 29464';
$string['defaultemailid'] = 'marketing@kallista-btm.sch.id';
$string['defaultphoneno'] = '(0778) 7482199';
$string['emailid'] = 'marketing@kallista-btm.sch.id';
$string['fburl'] = 'Facebook';
$string['fburl_default'] = 'https://www.facebook.com/sekolahkallistabtm/';
...
$string['infoblocktitledefault'] = 'Nama Sekolah';
$string['infoblocktitledesc'] = '';
$string['infolink'] = 'Info Links';
$string['infolinkdefault'] = '';
$string['infolink_desc'] = '';
$string['logo'] = 'Logo';
...
$string['whoweare_title_default'] = 'Sekolah Kalista';
